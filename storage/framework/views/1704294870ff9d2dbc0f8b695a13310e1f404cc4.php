...
<?php if(App::environment('local')): ?>
  ...
  <link rel="stylesheet" href="<?php echo e(URL::asset('css/slick.css', array(),true)); ?>" >
  <link rel="stylesheet" href="<?php echo e(URL::asset('css/slick-theme.css', array(),true)); ?>" >
<?php else: ?>
...
<![endif]-->
<link rel="shortcut icon" href="<?php echo URL::asset('favicon.ico'); ?>">
